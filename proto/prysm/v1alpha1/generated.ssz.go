...
// Hash: 609eb7083669c4fbb56905a8414faeeb78d5a76b9014ec92cad83c53c46a028a
package eth
...
func (b *BeaconStateDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Field (29) 'LastRewardedProposerIndex'
	b.LastRewardedProposerIndex = github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2736673:2736681]))
...
func (d *DeprecatedBlobSidecar) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(d.BlockParentRoot); size != 32 {
		err = ssz.ErrBytesLengthFn("--.BlockParentRoot", size, 32)
		return
	}
	dst = append(dst, d.BlockParentRoot...)

	// Field (4) 'ProposerIndex'
	dst = ssz.MarshalUint64(dst, uint64(d.ProposerIndex))

	// Field (5) 'Blob'
	if size := len(d.Blob); size != 131072 {
		err = ssz.ErrBytesLengthFn("--.Blob", size, 131072)
		return
	}
	...
	if size := len(d.KzgCommitment); size != 48 {
		err = ssz.ErrBytesLengthFn("--.KzgCommitment", size, 48)
		return
	}
	dst = append(dst, d.KzgCommitment...)

	// Field (7) 'KzgProof'
	if size := len(d.KzgProof); size != 48 {
		err = ssz.ErrBytesLengthFn("--.KzgProof", size, 48)
		return
	}
	dst = append(dst, d.KzgProof...)
...
func (d *DeprecatedBlobSidecar) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Slot'
	d.Slot = github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[40:48]))

	// Field (3) 'BlockParentRoot'
	if cap(d.BlockParentRoot) == 0 {
		d.BlockParentRoot = make([]byte, 0, len(buf[48:80]))
	}
	d.BlockParentRoot = append(d.BlockParentRoot, buf[48:80]...)

	// Field (4) 'ProposerIndex'
	d.ProposerIndex = github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[80:88]))

	// Field (5) 'Blob'
	if cap(d.Blob) == 0 {
		d.Blob = make([]byte, 0, len(buf[88:131160]))
	}
	d.Blob = append(d.Blob, buf[88:131160]...)

	// Field (6) 'KzgCommitment'
	if cap(d.KzgCommitment) == 0 {
		d.KzgCommitment = make([]byte, 0, len(buf[131160:131208]))
	}
	d.KzgCommitment = append(d.KzgCommitment, buf[131160:131208]...)

	// Field (7) 'KzgProof'
	if cap(d.KzgProof) == 0 {
		d.KzgProof = make([]byte, 0, len(buf[131208:131256]))
	}
	d.KzgProof = append(d.KzgProof, buf[131208:131256]...)
...
func (d *DeprecatedBlobSidecar) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	hh.PutBytes(d.BlockParentRoot)

	// Field (4) 'ProposerIndex'
	hh.PutUint64(uint64(d.ProposerIndex))
...
func (s *SignedBlobSidecar) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (0) 'Message'
	if s.Message == nil {
		s.Message = new(DeprecatedBlobSidecar)
	}
	if dst, err = s.Message.MarshalSSZTo(dst); err != nil {
		return
	}
