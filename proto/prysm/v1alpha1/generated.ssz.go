...
// Hash: a7f341fcd10b2aa776f251b97966938ab3a0fb4fe74adf609726fc0e88868e02
package eth
...
func (a *AggregateAttestationAndProof) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'AggregatorIndex'
	a.AggregatorIndex = github_com_stratisproject_prysm_stratis_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[0:8]))
...
func (a *AttestationData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	a.Slot = github_com_stratisproject_prysm_stratis_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))

	// Field (1) 'CommitteeIndex'
	a.CommitteeIndex = github_com_stratisproject_prysm_stratis_consensus_types_primitives.CommitteeIndex(ssz.UnmarshallUint64(buf[8:16]))
...
func (c *Checkpoint) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Epoch'
	c.Epoch = github_com_stratisproject_prysm_stratis_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[0:8]))
...
func (b *BeaconBlock) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	b.Slot = github_com_stratisproject_prysm_stratis_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))

	// Field (1) 'ProposerIndex'
	b.ProposerIndex = github_com_stratisproject_prysm_stratis_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[8:16]))
...
func (v *VoluntaryExit) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Epoch'
	v.Epoch = github_com_stratisproject_prysm_stratis_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[0:8]))

	// Field (1) 'ValidatorIndex'
	v.ValidatorIndex = github_com_stratisproject_prysm_stratis_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[8:16]))
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Slot'
	b.Slot = github_com_stratisproject_prysm_stratis_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[40:48]))
...
func (f *Fork) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Epoch'
	f.Epoch = github_com_stratisproject_prysm_stratis_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[8:16]))
...
func (p *PendingAttestation) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'InclusionDelay'
	p.InclusionDelay = github_com_stratisproject_prysm_stratis_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[132:140]))

	// Field (3) 'ProposerIndex'
	p.ProposerIndex = github_com_stratisproject_prysm_stratis_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[140:148]))
...
func (s *SyncAggregatorSelectionData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	s.Slot = github_com_stratisproject_prysm_stratis_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))
...
func (b *BeaconStateCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_stratisproject_prysm_stratis_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2736641:2736649]))
...
func (b *BeaconStateDeneb) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (28) 'StakingContractAddress'
	if size := len(b.StakingContractAddress); size != 20 {
		err = ssz.ErrBytesLengthFn("--.StakingContractAddress", size, 20)
		return
	}
	dst = append(dst, b.StakingContractAddress...)

	// Field (29) 'LastRewardedProposerIndex'
	dst = ssz.MarshalUint64(dst, uint64(b.LastRewardedProposerIndex))

	// Field (30) 'LastRewardedProposerUpdated'
	dst = ssz.MarshalBool(dst, b.LastRewardedProposerUpdated)
...
func (b *BeaconStateDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Field (28) 'StakingContractAddress'
	if cap(b.StakingContractAddress) == 0 {
		b.StakingContractAddress = make([]byte, 0, len(buf[2736653:2736673]))
	}
	b.StakingContractAddress = append(b.StakingContractAddress, buf[2736653:2736673]...)

	// Field (29) 'LastRewardedProposerIndex'
	b.LastRewardedProposerIndex = github_com_stratisproject_prysm_stratis_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2736673:2736681]))

	// Field (30) 'LastRewardedProposerUpdated'
	b.LastRewardedProposerUpdated = ssz.UnmarshalBool(buf[2736681:2736682])
...
func (b *BeaconStateDeneb) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	hh.PutBytes(b.StakingContractAddress)

	// Field (29) 'LastRewardedProposerIndex'
	hh.PutUint64(uint64(b.LastRewardedProposerIndex))

	// Field (30) 'LastRewardedProposerUpdated'
	hh.PutBool(b.LastRewardedProposerUpdated)
...
func (s *Status) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'FinalizedEpoch'
	s.FinalizedEpoch = github_com_stratisproject_prysm_stratis_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[36:44]))
	...
	// Field (4) 'HeadSlot'
	s.HeadSlot = github_com_stratisproject_prysm_stratis_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[76:84]))
...
func (b *BeaconBlocksByRangeRequest) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'StartSlot'
	b.StartSlot = github_com_stratisproject_prysm_stratis_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))
...
func (e *ENRForkID) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'NextForkEpoch'
	e.NextForkEpoch = github_com_stratisproject_prysm_stratis_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[8:16]))
...
func (s *SyncCommitteeMessage) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'ValidatorIndex'
	s.ValidatorIndex = github_com_stratisproject_prysm_stratis_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[40:48]))
...
func (c *ContributionAndProof) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'AggregatorIndex'
	c.AggregatorIndex = github_com_stratisproject_prysm_stratis_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[0:8]))
...
func (v *Validator) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'ActivationEligibilityEpoch'
	v.ActivationEligibilityEpoch = github_com_stratisproject_prysm_stratis_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[89:97]))

	// Field (5) 'ActivationEpoch'
	v.ActivationEpoch = github_com_stratisproject_prysm_stratis_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[97:105]))

	// Field (6) 'ExitEpoch'
	v.ExitEpoch = github_com_stratisproject_prysm_stratis_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[105:113]))

	// Field (7) 'WithdrawableEpoch'
	v.WithdrawableEpoch = github_com_stratisproject_prysm_stratis_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[113:121]))
...
func (b *BLSToExecutionChange) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'ValidatorIndex'
	b.ValidatorIndex = github_com_stratisproject_prysm_stratis_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[0:8]))
