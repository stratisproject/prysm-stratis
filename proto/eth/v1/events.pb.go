...
type EventChainReorg struct {
	...
	Epoch               github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch `protobuf:"varint,7,opt,name=epoch,proto3" json:"epoch,omitempty" cast-type:"github.com/stratisproject/prysm-stratis/consensus-types/primitives.Epoch"`
