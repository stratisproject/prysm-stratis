...
type BeaconStateDeneb struct {
	...
	LastRewardedProposerIndex    github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,12002,opt,name=last_rewarded_proposer_index,json=lastRewardedProposerIndex,proto3" json:"last_rewarded_proposer_index,omitempty" cast-type:"github.com/prysmaticlabs/prysm/v4/consensus-types/primitives.ValidatorIndex"`
...
func (x *BeaconStateDeneb) GetLastRewardedProposerIndex() github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex {
	if x != nil {
