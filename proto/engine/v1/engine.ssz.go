...
// Hash: 44a1eced0c38d7cc2225e3c1bf4a664a9f686cb8107a519e8e10b21831c45f3c
package enginev1
...
func (w *Withdrawal) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'ValidatorIndex'
	w.ValidatorIndex = github_com_stratisproject_prysm_stratis_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[8:16]))
